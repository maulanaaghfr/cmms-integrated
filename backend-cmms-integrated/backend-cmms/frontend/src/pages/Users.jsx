...
import { Card, Table, Pill, Button, Modal, Field, Input, Select, SearchInput, Reveal } from "../components/kit";
import { listUsers, createUser, updateUser, listSites, listTeams } from "../lib/organization";
...
export default function Users() {
  ...
  const columns = [
    ...
    { key: "actions", header: "Actions", render: (member) => <button type="button" onClick={(event) => { event.stopPropagation(); setSelectedUser(member); }} className="text-[11px] font-semibold text-slate-600 hover:text-primary">View</button> },
  ];
