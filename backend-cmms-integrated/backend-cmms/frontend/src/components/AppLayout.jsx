...
const NAV = [
  ...
  { to: "/notifications", label: "Notifications", icon: BellRing, roles: ["company_admin", "manager", "supervisor"] },
  { to: "/requests", label: "Maintenance Requests", icon: ClipboardPlus, roles: ["operator", "company_admin", "manager", "supervisor"] },
  { to: "/work-orders", label: "Work Orders", icon: ClipboardList, roles: ["company_admin", "manager", "supervisor", "technician"] },
  { to: "/assets", label: "Assets", icon: Boxes, roles: ["company_admin", "manager", "supervisor", "technician"], children: [{ label: "All Assets", to: "/assets" }, { label: "Categories", to: "/asset-categories" }, { label: "Sites", to: "/sites" }, { label: "Locations", to: "/locations" }] },
  { to: "/users", label: "People", icon: Users2, roles: ["company_admin"], children: [{ label: "Users", to: "/users" }, { label: "Teams", to: "/teams" }] },
  { to: "/preventive", label: "Preventive Maintenance", icon: CalendarClock, roles: ["company_admin", "manager", "supervisor"] },
  ...
  { to: "/inventory", label: "Inventory", icon: Package, roles: ["company_admin", "manager", "supervisor"] },
